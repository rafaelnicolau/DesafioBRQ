...
//    car = cars
    ...
    lbMarca.text = viewData.marca
    lbNome.text = viewData.nome
    lbQuant.text = "Unidade: \(viewData.quantidade)"
    if let url = URL(string: viewData.imagem) {
